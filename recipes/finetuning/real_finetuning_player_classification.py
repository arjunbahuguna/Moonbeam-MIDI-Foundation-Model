...
import importlib
import fire
sys.path.insert(0, "/home/arjbah/Desktop/Coursework/SYM/Moonbeam-MIDI-Foundation-Model/src")
#from llama_recipes.real_finetuning_player_classification import main

# Add repo src root to sys.path (package root), not a package subfolder.
...
if __name__ == "__main__":
    mod = importlib.import_module("llama_recipes.real_finetuning_player_classification")
    fire.Fire(mod.main) # EDIT: lazy load llama_recipes module